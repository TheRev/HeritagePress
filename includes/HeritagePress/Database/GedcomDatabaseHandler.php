...
class GedcomDatabaseHandler {
    ...
    private function storeIndividual($individual, $file_id) {
        ...
        $wpdb->insert(
            $wpdb->prefix . 'heritage_press_individuals',
            $data
        );
    ...
    private function storeFamily($family, $file_id) {
        ...
        $wpdb->insert(
            $wpdb->prefix . 'heritage_press_families',
            $data
        );
    ...
    private function storeSource($source, $file_id) {
        ...
        $wpdb->insert(
            $wpdb->prefix . 'heritage_press_sources',
            $data
        );
    ...
    private function storeMedia($media, $file_id) {
        ...
        $wpdb->insert(
            $wpdb->prefix . 'heritage_press_media',
            $data
        );
    ...
    private function storePlace($place, $file_id) {
        ...
        $wpdb->insert(
            $wpdb->prefix . 'heritage_press_places',
            $data
        );
