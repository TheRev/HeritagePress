...
<div class="hp-export-container">
    ...
    <form method="post" id="hp-gedcom-export-form" class="hp-form">
        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    <select name="tree_id" id="hp-export-tree" required>
                        ...
                        <?php
                        // Placeholder for tree selection options
                        // This will be populated by the ImportExportManager class
                        ?>
                    </select>
                </td>
            </tr>
            <tr>
                <th scope="row">
                    <label for="hp-export-gedcom-version"><?php esc_html_e('GEDCOM Version', 'heritagepress'); ?></label>
                </th>
                <td>
            ...
            <tr>
                ...
                <td>
                    <fieldset>
                        <legend class="screen-reader-text"><?php esc_html_e('Export Format', 'heritagepress'); ?></legend>
                        
                        <label for="hp-export-format-gedcom">
                            <input type="radio" name="export_format" id="hp-export-format-gedcom" value="gedcom" checked>
            ...
            <tr>
                ...
                <td>
                    <fieldset>
                        <legend class="screen-reader-text"><?php esc_html_e('Privacy Options', 'heritagepress'); ?></legend>
        ...
        <div class="hp-export-filters">
            ...
            <details>
                ...
                <div class="hp-filter-content">
                    ...
                    <p class="description"><?php esc_html_e('This feature will be available in a future update.', 'heritagepress'); ?></p>
                </div>
            </details>
