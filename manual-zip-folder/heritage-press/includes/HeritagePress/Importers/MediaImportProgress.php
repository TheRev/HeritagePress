...
class MediaImportProgress {
    const OPTION_KEY = 'heritage_press_media_import_progress';
    ...
    public function __construct($import_id = null) {
        $this->import_id = $import_id ?? uniqid('media_import_');
        $this->settings = [            'batch_size' => get_option('heritage_press_import_batch_size', self::BATCH_SIZE),
